...
function stageLabel(activeTurnStage) {
  if (activeTurnStage === 'active.resolvedTurn') return 'Result'
  if (activeTurnStage === 'active.questionSelected') return 'Question'
  if (activeTurnStage === 'active.nextTurn') return 'Next Turn'
  return 'Ready'
}
  ...
  return (
    <section className="relations-stage relations-stage--drill">
      <div className="relations-stage-banner panel-card">
        <div>
          <p className="dashboard-hero__eyebrow">Drill</p>
      ...
      <div className="relations-drill-grid">
        <div className="relations-drill-main">
        ...
        <section className="panel-card relations-question-selection-panel">
          <div className="section-head">
            <div>
              ...
              <p>שלוש שאלות גלויות בלבד. לא לוח בקרה, אלא צעד אחד.</p>
            </div>
          </div>
